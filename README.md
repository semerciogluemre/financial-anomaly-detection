...
![PR Curve](fraud-detection/outputs/pr_curve.png)
...
![Error Distribution](fraud-detection/outputs/error_distribution.png)
...
![SHAP Summary](fraud-detection/outputs/shap_summary.png)
...
![SHAP Waterfall](fraud-detection/outputs/shap_waterfall_10.png)
...
![Latent Space](fraud-detection/outputs/latent_space.png)
...
### Threshold Analysis
![Threshold Analysis](fraud-detection/outputs/threshold_analysis_ensemble.png)
